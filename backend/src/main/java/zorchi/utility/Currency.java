...
public class Currency {
   ...
   * <p>
   * Impedisce che la rappresentazione floating point dei due valori faccia comparire un errore durante la somma.
   * 
   ...
   * <p>
   * Impedisce che la rappresentazione floating point dei due valori faccia comparire un errore durante la sottrazione.
   * 
